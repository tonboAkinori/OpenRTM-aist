...
namespace RTC
{
  ...
  void ConfigAdmin::setOnUpdate(OnUpdateCallback* cb)
  {
    ...
    m_listeners.configsetname_[static_cast<uint8_t>(ConfigurationSetNameListenerType::ON_UPDATE)].addListener(cb, false);
  }
  ...
  void ConfigAdmin::setOnUpdateParam(OnUpdateParamCallback* cb)
  {
    ...
    m_listeners.configparam_[static_cast<uint8_t>(ConfigurationParamListenerType::ON_UPDATE)].addListener(cb, false);
  }
  ...
  void ConfigAdmin::setOnSetConfigurationSet(OnSetConfigurationSetCallback* cb)
  {
    ...
    m_listeners.configset_[static_cast<uint8_t>(ConfigurationSetListenerType::ON_SET)].addListener(cb, false);
  }
  ...
  void ConfigAdmin::setOnAddConfigurationSet(OnAddConfigurationAddCallback* cb)
  {
    ...
    std::cerr << "Use addConfigurationSetListener instead." << std::endl;
    m_listeners.configset_[static_cast<uint8_t>(ConfigurationSetListenerType::ON_ADD)].addListener(cb, false);
  }
  ...
  ConfigAdmin::setOnRemoveConfigurationSet(OnRemoveConfigurationSetCallback* cb)
  {
    ...
    std::cerr << "Use addConfigurationSetNameListener instead." << std::endl;
    m_listeners.configsetname_[static_cast<uint8_t>(ConfigurationSetNameListenerType::ON_REMOVE)].addListener(cb, false);
  }
  ...
  void ConfigAdmin::setOnActivateSet(OnActivateSetCallback* cb)
  {
    ...
    std::cerr << "Use addConfigurationSetNameListener instead." << std::endl;
    m_listeners.configsetname_[static_cast<uint8_t>(ConfigurationSetNameListenerType::ON_ACTIVATE)].addListener(cb, false);
  }
  //
  ...
  {
    m_listeners.configsetname_[static_cast<uint8_t>(ConfigurationSetNameListenerType::ON_UPDATE)].notify(config_set);
  }
  ...
  ConfigAdmin::onUpdateParam(const char* config_param, const char* config_value)
  {
    ...
    m_listeners.configparam_[static_cast<uint8_t>(ConfigurationParamListenerType::ON_UPDATE)].notify(config_param,
                                                            config_value);
  }
  ...
  {
    m_listeners.configset_[static_cast<uint8_t>(ConfigurationSetListenerType::ON_SET)].notify(config_set);
  }
  ...
  {
    m_listeners.configset_[static_cast<uint8_t>(ConfigurationSetListenerType::ON_ADD)].notify(config_set);
  }
  ...
  {
    m_listeners.configsetname_[static_cast<uint8_t>(ConfigurationSetNameListenerType::ON_REMOVE)].notify(config_id);
  }
  ...
  {
    m_listeners.configsetname_[static_cast<uint8_t>(ConfigurationSetNameListenerType::ON_ACTIVATE)].notify(config_id);
  }
