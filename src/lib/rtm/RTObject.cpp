...
namespace RTC
{
  /*!
   * @if jp
   * @brief RT¥³¥ó¥Ý¡¼¥Í¥ó¥È¤Î¥Ç¥Õ¥©¥ë¥È¥×¥í¥Õ¥¡¥¤¥ë
   * @else
  ...
  /*!
   * @if jp
   * @brief Æ°ºî¼þ´üÊÑ¹¹ÄÌÃÎÍÑ¥³¡¼¥ë¥Ð¥Ã¥¯´Ø¿ô
   * @else
  ...
  /*!
   * @if jp
   * @brief [DataFlowComponentAction CORBA interface] ¼Â¹Ô¼þ´üÊÑ¹¹ÄÌÃÎ
   * @else
  ...
  /*!
   * @if jp
   * @brief [local interface] Ì¾Á°»ØÄê¤Ë¤è¤ê Port ¤ÎÅÐÏ¿¤òºï½ü¤¹¤ë
   * @else
 ...
 bool RTObject_impl::isOwnExecutionContext(RTC::UniqueId ec_id)
  ...
  /*!
  * @if jp
  * @brief [local interface] SDO service provider ä‚Ž¹æ¶Ž£ä‚¹ãŽ²KäƒŽ²¦´(ä§åŽµ)ê™¤ãŽ±8ä‚Ž¶)  * @else
  * @brief [local interface] Remove a SDO service provider
  * @endif
  */
   ...
   * @return ÆÉ¤ß¹þ¤ß·ë²Ì(Á´¥Ý¡¼¥È¤ÎÆÉ¤ß¹þ¤ßÀ®¸ù:true¡¤¼ºÇÔ:false)
   * @else
  ...
  * @endif
   ...
   * @return ÆÉ¤ß¹þ¤ß·ë²Ì(Á´¥Ý¡¼¥È¤Ø¤Î½ñ¤­¹þ¤ßÀ®¸ù:true¡¤¼ºÇÔ:false)
   * @else
   ...
   * @if jp
   *
   * @brief onExecute()¼Â¹ÔÁ°¤Ç¤ÎreadAll()¥á¥½¥Ã¥É¤Î¸Æ½Ð¤òÍ­¸ú¤Þ¤¿¤ÏÌµ¸ú¤Ë¤¹¤ë¡£
   *
   * ¤³¤Î¥á¥½¥Ã¥É¤ò¥Ñ¥é¥á¡¼¥¿¤òtrue¤È¤·¤Æ¸Æ¤Ö»ö¤Ë¤è¤ê¡¢onExecute()¼Â¹ÔÁ°¤Ë
   * readAll()¤¬¸Æ½Ð¤µ¤ì¤ë¤è¤¦¤Ë¤Ê¤ë¡£
   * ¥Ñ¥é¥á¡¼¥¿¤¬false¤Î¾ì¹ç¤Ï¡¢readAll()¸Æ½Ð¤òÌµ¸ú¤Ë¤¹¤ë¡£
   *
   ...
   * @if jp
   *
   * @brief onExecute()¼Â¹Ô¸å¤ËwriteAll()¥á¥½¥Ã¥É¤Î¸Æ½Ð¤òÍ­¸ú¤Þ¤¿¤ÏÌµ¸ú¤Ë¤¹¤ë¡£
   *
   * ¤³¤Î¥á¥½¥Ã¥É¤ò¥Ñ¥é¥á¡¼¥¿¤òtrue¤È¤·¤Æ¸Æ¤Ö»ö¤Ë¤è¤ê¡¢onExecute()¼Â¹Ô¸å¤Ë
   * writeAll()¤¬¸Æ½Ð¤µ¤ì¤ë¤è¤¦¤Ë¤Ê¤ë¡£
   * ¥Ñ¥é¥á¡¼¥¿¤¬false¤Î¾ì¹ç¤Ï¡¢writeAll()¸Æ½Ð¤òÌµ¸ú¤Ë¤¹¤ë¡£
   *
