...
namespace RTC
{
  ...
  void ComponentObserverConsumer::setConfigurationListeners()
  {
    m_configMsg.updateConfigParamListener = 
      m_rtobj->addConfigurationParamListener(ConfigurationParamListenerType::ON_UPDATE,
                                             m_configMsg,
                                             &ConfigAction::updateConfigParam);
    m_configMsg.setConfigSetListener = 
      m_rtobj->addConfigurationSetListener(ConfigurationSetListenerType::ON_SET,
                                             m_configMsg,
                                             &ConfigAction::setConfigSet);
    m_configMsg.addConfigSetListener = 
      m_rtobj->addConfigurationSetListener(ConfigurationSetListenerType::ON_ADD,
                                             m_configMsg,
                                             &ConfigAction::addConfigSet);
    m_configMsg.updateConfigSetListener = 
      m_rtobj->addConfigurationSetNameListener(ConfigurationSetNameListenerType::ON_UPDATE,
                                               m_configMsg,
                                               &ConfigAction::updateConfigSet);
    m_configMsg.removeConfigSetListener = 
      m_rtobj->addConfigurationSetNameListener(ConfigurationSetNameListenerType::ON_REMOVE,
                                               m_configMsg,
                                               &ConfigAction::removeConfigSet);
    m_configMsg.activateConfigSetListener = 
      m_rtobj->addConfigurationSetNameListener(ConfigurationSetNameListenerType::ON_ACTIVATE,
                                               m_configMsg,
  ...
  void ComponentObserverConsumer::unsetConfigurationListeners()
  {
    ...
    if (m_configMsg.updateConfigParamListener != nullptr)
      {
        m_rtobj->
          removeConfigurationParamListener(ConfigurationParamListenerType::ON_UPDATE,
                                      m_configMsg.updateConfigParamListener);
        m_configMsg.updateConfigParamListener = nullptr;
      }
    if (m_configMsg.setConfigSetListener != nullptr)
      {
        m_rtobj->removeConfigurationSetListener(ConfigurationSetListenerType::ON_SET,
                                           m_configMsg.setConfigSetListener);
        m_configMsg.setConfigSetListener = nullptr;
      }
    if (m_configMsg.addConfigSetListener != nullptr)
      {
        m_rtobj->removeConfigurationSetListener(ConfigurationSetListenerType::ON_ADD,
                                            m_configMsg.addConfigSetListener);
        m_configMsg.addConfigSetListener = nullptr;
      }
    if (m_configMsg.updateConfigSetListener != nullptr)
      {
        m_rtobj->removeConfigurationSetNameListener(ConfigurationSetNameListenerType::ON_UPDATE,
                                          m_configMsg.updateConfigSetListener);
        m_configMsg.updateConfigSetListener = nullptr;
      }
    if (m_configMsg.removeConfigSetListener != nullptr)
      {
        m_rtobj->removeConfigurationSetNameListener(ConfigurationSetNameListenerType::ON_REMOVE,
                                          m_configMsg.removeConfigSetListener);
        m_configMsg.removeConfigSetListener = nullptr;
      }
    if (m_configMsg.activateConfigSetListener != nullptr)
      {
        m_rtobj->removeConfigurationSetNameListener(ConfigurationSetNameListenerType::ON_ACTIVATE,
                                        m_configMsg.activateConfigSetListener);
